...
| v1_7   | StratifiedKFold Pipeline    | None (use all data)                        | RandomOverSampler (in pipeline)                | StratifiedKFold (2-fold)     | No            | No                   | Best k=5 features, stable results                    | Feature analysis, model comparison           | Best for tiny data   |
